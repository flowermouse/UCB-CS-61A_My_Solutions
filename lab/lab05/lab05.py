def berry_finder(t):
    ...
    if is_leaf(t):
        ...
        return bool([branch for branch in branches(t) if berry_finder(branch)])
...
def closer_city(lat, lon, city_a, city_b):
    ...
    'Bucharest'
    """
    city_now = make_city('now', lat, lon)
    distance_a, distance_b = distance(city_now, city_a), distance(city_now, city_b)
...
def dejavu(t, n):
    ...
    if is_leaf(t):
        ...
        return any(dejavu(branch, n - label(t)) for branch in branches(t))
